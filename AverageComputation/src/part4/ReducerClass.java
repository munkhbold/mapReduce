...
public class ReducerClass extends Reducer<PairW, IntWritable, Text, Text> {
    ...
    public void reduce(PairW key, Iterable<IntWritable> values, Context context) throws IOException, InterruptedException{
    	String u = key.getKey();
